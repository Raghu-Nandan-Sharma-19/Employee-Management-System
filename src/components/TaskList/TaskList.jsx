...
const TaskList = () => {
  return (
    <div id='tasklist' className='h-[55%] flex  flex-row overflow-x-auto items-center justify-start gap-5 
    flex-nowrap w-full py-5 mt-10 '>
        <div className='h-full flex-shrink-0 w-[80%] p-5 lg:w-[300px] rounded-xl bg-red-400'>
