...
const FailedTask = ({ data }) => {
    return (
        <div className='flex-shrink-0 h-full w-full sm:w-[300px] p-5 bg-yellow-400 rounded-xl'>
            ...
            <h2 className='mt-5 text-xl sm:text-2xl font-semibold'>{data.taskTitle}</h2>
