...
const FailedTask = ({data}) => {
  return (
    <div className='flex-shrink-0 w-[280px] sm:w-[300px] p-3 sm:p-4 md:p-5 bg-yellow-400 rounded-xl'>
        ...
        <div className='mt-4 sm:mt-5 md:mt-6'>
            <button className='w-full bg-red-500 hover:bg-red-600 rounded font-medium py-1.5 px-2 text-xs transition-colors duration-300'>
                Failed
            </button>
        </div>
    </div>
